...
# python run.py --split https://www.youtube.com/watch?v=NGuoJ0CQfqA
...
def get_best_mp4_single_file(download_source:str, description_file:str,
    ...
    subprocess.run(["youtube-dl", "--write-description", "-f", "bestaudio",
...
def split_mp4(chapters:list, download_filename:str, download_name:str)->None:
    ...
    for current_index, current_chapter in enumerate(chapters):
        ...
        subprocess.run(["ffmpeg", "-i", download_filename, 
                        "-acodec", "copy", "-ss", start_time,  "-to", end_time, output_name])
...
if __name__ == '__main__':
    ...
    for link_to_download in args.links:
        ...
        #download_name = remove_accents()
        print ("download filename", download_name)
